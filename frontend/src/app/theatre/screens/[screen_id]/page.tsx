          ...
          if (seatData.length > 0) {
            ...
            seatData.forEach(seatRow => {
                seatRow.forEach(seat => {
                    const { row_num, seat_number, seat_type_name } = seat;
                    console.log(seat)
